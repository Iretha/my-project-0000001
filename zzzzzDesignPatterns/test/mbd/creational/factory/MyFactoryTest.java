...
public class MyFactoryTest extends BaseTestCase {
	...
	/**
	 * Testing {@link MyFactory#createInstance(AObjectsEnum e)}
	 */
	@Test
	public void testCreateInstance() {
		try {
			...
			IAObject o11 = MyFactory.getInstance().createInstance(AObjectsEnum.SpecObj1);
			assertNotNull(o11);
			assertEquals(AObjectsEnum.SpecObj1.getKey(), o11.getClass().getSimpleName());
			IAObject o12 = MyFactory.getInstance().createInstance(AObjectsEnum.SpecObj1);
			assertNotNull(o12);
			assertEquals(AObjectsEnum.SpecObj1.getKey(), o12.getClass().getSimpleName());
			assertNotSame(o11, o12);

			IAObject o21 = MyFactory.getInstance().createInstance(AObjectsEnum.SpecObj2);
			assertNotNull(o21);
			assertEquals(AObjectsEnum.SpecObj2.getKey(), o21.getClass().getSimpleName());
			IAObject o22 = MyFactory.getInstance().createInstance(AObjectsEnum.SpecObj2);
			assertNotNull(o22);
	...
	/**
	 * Testing {@link MyFactory#createInstanceUsingReflection(AObjectsEnum e)}
	 */
	@Test
